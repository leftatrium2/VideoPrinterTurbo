...
PIPELINE_STATUS_INIT = 0
PIPELINE_STATUS_CREATE = 1
PIPELINE_STATUS_COMPLETE = 2
PIPELINE_STATUE_DOWNLOADER_START = 11
PIPELINE_STATUE_DOWNLOADER_PROGRESS = 12
PIPELINE_STATUE_DOWNLOADER_COMPLETE = 13
PIPELINE_STATUE_DOWNLOADER_ERROR = 14
PIPELINE_STATUE_ASR_START = 21
PIPELINE_STATUE_ASR_PROGRESS = 22
PIPELINE_STATUE_ASR_COMPLETE = 23
PIPELINE_STATUE_ASR_ERROR = 24
PIPELINE_STATUE_LLM_START = 31
PIPELINE_STATUE_LLM_PROGRESS = 32
PIPELINE_STATUE_LLM_COMPLETE = 33
PIPELINE_STATUE_LLM_ERROR = 34
PIPELINE_STATUE_TTS_START = 41
PIPELINE_STATUE_TTS_PROGRESS = 42
PIPELINE_STATUE_TTS_COMPLETE = 43
PIPELINE_STATUE_TTS_ERROR = 44
PIPELINE_STATUE_SUBTITLE_START = 51
PIPELINE_STATUE_SUBTITLE_COMPLETE = 52
PIPELINE_STATUE_BGM_START = 61
PIPELINE_STATUE_BGM_ERROR = 62
...
# Local whisper
TASK_CONFIG_ASR_FROM_LOCAL_WHISPER = 2
# remote whisper
TASK_CONFIG_ASR_FROM_REMOTE_WHISPER = 3
# Tencent Cloud ASR
TASK_CONFIG_ASR_FROM_TENCENT_CLOUD = 4
# XFYun ASR
TASK_CONFIG_ASR_FROM_XF_YUN = 5
# openai asr
TASK_CONFIG_ASR_FROM_OPENAI = 6
# azure ASR
TASK_CONFIG_ASR_FROM_AZURE = 7
# bytedance ASR
TASK_CONFIG_ASR_FROM_BYTEDANCE = 8
...
TASK_CONFIG_REMOTE_VLLM_WHISPER = 1
TASK_CONFIG_REMOTE_WHISPER_CPP = 2
# tts engine server list
TTS_LIST_AZURE_TTS_V1 = 1
TTS_LIST_AZURE_TTS_V1_VAL = "TTS_LIST_AZURE_TTS_V1"
TTS_LIST_AZURE_TTS_V2 = 2
TTS_LIST_AZURE_TTS_V2_VAL = "TTS_LIST_AZURE_TTS_V2"
TTS_LIST_SILICON_FLOW_TTS = 3
TTS_LIST_SILICON_FLOW_TTS_VAL = "TTS_LIST_SILICON_FLOW_TTS"
TTS_LIST_GOOGLE_GEMINI_TTS = 4
TTS_LIST_GOOGLE_GEMINI_TTS_VAL = "TTS_LIST_GOOGLE_GEMINI_TTS"
# tts voice preview
TTS_CONFIG_PREVIEW = {
    "zh": "你好，这是一段试听音频",
...
# pipeline module
PIPELINE_ERR_VALUE = 1301
PIPELINE_ERR_FILE_NOT_FOUND = 1302
PIPELINE_ERR_SUBPROCESS_NONE_ZERO = 1303
PIPELINE_ERR_TIMEOUT_EXPIRED = 1304
PIPELINE_ERR_IMPORT = 1304
# pipeline downloader module
PIPELINE_ERR_DOWNLOADER_NONE = 1401
PIPELINE_ERR_YT_DLP = 1402
# pipeline asr module
PIPELINE_ERR_ASR_UNKNOWN = 1500
PIPELINE_ERR_ASR_SEGMENTS = 1501
PIPELINE_ERR_ASR_TRANSCRIBER = 1502
PIPELINE_ERR_ASR_NETWORK = 1503
PIPELINE_ERR_ASR_RECOGNITION_TASK = 1504
PIPELINE_ERR_ASR_API = 1505
# pipeline llm module
PIPELINE_ERR_LLM_CONFIG = 1551
PIPELINE_ERR_LLM_APIKEY_OR_BASEURL = 1552
PIPELINE_ERR_LLM_MODEL = 1553
PIPELINE_ERR_LLM_RESPONSE_NOT_JSON = 1554
PIPELINE_ERR_LLM_OPENAI_RESPONSE = 1555
# pipeline tts module
PIPELINE_ERR_TTS_SRT_PARSE = 1601
PIPELINE_ERR_TTS_CONVERT = 1602
# pipeline ffmpeg or ffprobe module
PIPELINE_ERR_FFPROBE_DURATION = 1701
PIPELINE_ERR_FFMPEG_TRANSCRIBER = 1702
# pipeline video overlay module
PIPELINE_ERR_VIDEO_OVERLAY_KEYWORD_FROM_LLM = 1751
PIPELINE_ERR_VIDEO_OVERLAY_DB_CONFIG = 1752
