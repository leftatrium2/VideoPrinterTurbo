...
PIPELINE_STATUS_INI = 0
PIPELINE_STATUS_START = 1
PIPELINE_STATUS_CHECK_VIDEO = 2
PIPELINE_STATUS_DOWNLOADER = 3
PIPELINE_STATUS_ASR = 4
PIPELINE_STATUS_LLM = 5
PIPELINE_STATUS_TTS = 6
PIPELINE_STATUS_SUBTITLE = 7
PIPELINE_STATUS_BGM = 8
PIPELINE_STATUS_VIDEO_OVERLAY = 9
...
# pipeline module
PIPELINE_ERR_UNKNOWN = 1300
PIPELINE_ERR_VALUE = 1301
PIPELINE_ERR_KEY_IN_DICT = 1302
PIPELINE_ERR_FILE_NOT_FOUND = 1303
PIPELINE_ERR_SUBPROCESS_NONE_ZERO = 1304
PIPELINE_ERR_TIMEOUT_EXPIRED = 1305
PIPELINE_ERR_IMPORT = 1306
PIPELINE_ERR_FILE_SAVE = 1307
# pipeline downloader module
PIPELINE_ERR_DOWNLOADER_NONE = 1401
PIPELINE_ERR_YT_DLP = 1402
PIPELINE_ERR_DOWNLOADER_SAVE_LOCAL_PATH = 1403
# pipeline asr module
PIPELINE_ERR_ASR_UNKNOWN = 1500
PIPELINE_ERR_ASR_NOT_CONFIGURATION = 1501
PIPELINE_ERR_ASR_SEGMENTS = 1502
PIPELINE_ERR_ASR_TRANSCRIBER = 1503
PIPELINE_ERR_ASR_NETWORK = 1504
PIPELINE_ERR_ASR_RECOGNITION_TASK = 1505
PIPELINE_ERR_ASR_API = 1506
# pipeline llm module
...
PIPELINE_ERR_TTS_SERVICE = 1603
PIPELINE_ERR_TTS_CONFIG_DB = 1604
PIPELINE_ERR_TTS_RETURN = 1605
# pipeline ffmpeg or ffprobe module
PIPELINE_ERR_FFPROBE_DURATION = 1701
PIPELINE_ERR_FFMPEG_TRANSCRIBER = 1702
PIPELINE_ERR_FFPROBE_WIDTH_HEIGHT = 1703
...
PIPELINE_ERR_VIDEO_ASSEMBLY_SUBTITLE_POSITON = 1801
